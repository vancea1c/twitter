document.addEventListener('DOMContentLoaded', function () {
    const textarea = document.getElementById('xd');
...
// Function to hide the div based on its id
...
// Check if any divs are still visible
function checkVisibleDivs() {
    ...
    // Display the message if no visible divs are found
...
function openDialog() {
    const modalContainer = document.getElementsByClassName("tweet2")[0];
